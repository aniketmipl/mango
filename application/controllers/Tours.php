...
$this->load->view('common/header',$head_data);
	...
	public function vietnam_cambodia(){
		...
		// $filter_data['slider_image'] = 'images/tours/africa/african-safari-banner.jpg';
		//$filter_data['slider_mobile_image'] = 'images/tours/africa/african-safari.jpg';
		$filter_data['slider_image'] = 'git/VC/vietnam-cambodia-banner.jpg';
		$filter_data['slider_mobile_image'] = 'git/VC/vietnam-cambodia.jpg';
		$filter_data['sector']="Asia";
		$filter_data['sector_path']="CustomizedTours/customized_africa";
	...
	public function jordan_diamonds(){
		...
		$filter_data['slider_mobile_image'] = 'fit/JO2/jordan-diamonds-banner.jpg';
		$filter_data['sector']="Asia";
		$filter_data['sector_path']="CustomizedTours/customized_africa";
	...
	public function petra_moon_valley(){
		...
		$filter_data['slider_mobile_image'] = 'fit/JO3/petra-moon-valley-banner.jpg';
		$filter_data['sector']="Asia";
		$filter_data['sector_path']="CustomizedTours/customized_africa";
	...
	public function call_api($product_id,$product_code){
		$api_url ="https://203.112.144.254:8888/WebsiteData/WebsiteDataService.svc/getProductForWebsite?ProductID=".$product_id."&ProductCode=".$product_code;
