<head>
    ...
    <?php 
    if(isset($controller)){
        if($controller == 'group-tour-packages'){?>
    ...
    if($controller == 'tours' && $travel_type == 'GIT'){?>
    <meta name="description" content="Mango Holidays providing <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Group Tour Packages, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Tour, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Tour Group Tour Packages, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Tour Packages from Mumbai, Thane, Pune, India">  
    <meta name="keywords" content = "<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour packages, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour packages, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour from Mumbai, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour from Pune,<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?>  group tour from Thane, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?>  group tour from India ,<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour packages from Mumbai, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour packages from Pune, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour packages from Thane, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group tour packages from India, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour from Mumbai, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour from Pune, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour from Thane, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour from India, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour packages from Mumbai,<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour packages from Pune,<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour packages from Thane,<?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> group vacation tour packages from India,">
    <?php }

    if($controller == 'tours' && $travel_type == 'FIT'){?>
        <meta name="description" content="Mango Holidays providing <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Customized Tours, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Vacation Tour, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Customized Tours Packages, <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> Vacation Tour Packages from Mumbai, Pune, Thane, India">

        <meta name="keywords" content="customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour packages, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour, customised <?php echo $sector ;?> vacation tour packages, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour from Mumbai, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour from Pune,customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour from Thane, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour from India ,customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour packages from Mumbai, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour packages from Pune, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> tour packages from Thane, customised <?php echo $sector ;?> tour packages from India, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour from Mumbai, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour from Pune, customised <?php echo $sector ;?> vacation tour from Thane, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour from India, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour packages from Mumbai, customised <?php echo ucwords(str_replace('-',' ',str_replace("tour","",$this->uri->segment(2)))); ?> vacation tour packages from Pune,">   
    <?php }
        ...
        <div class="top_header">
            <div class="container">
                <div class="row">
                    ...
                    <!-- <a href="<?php echo base_url()?>franchisee"><i class="fa fa-street-view" aria-hidden="true"></i> &nbsp;Become Franchisee </a>  -->
                    </span>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInUp" data-out="fadeOutDown">
                        ...
                        <!-- <li class="dropdown group_tour <?php if (($controller =='GroupTours')||($controller =='group-tour-packages')){
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url()?>group-tour-packages/sri-lanka">Sri Lanka</a></li>
                                <li><a href="<?php echo base_url()?>group-tour-packages/india">India</a></li>
                            </ul>
                        </li>     -->
                        <!--remove medium-width class for normal megameu-->
                        <li class="dropdown megamenu-fw medium-width group_tour <?php if (($controller =='GroupTours')||($controller =='group-tour-packages')){
                            echo 'active';
                        } ?>">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Group Tours </a>
                                                ...
                                                <div class="content">
                                                    <ul class="menu-col">
                                                      <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <li><a href="<?php echo base_url()?>customized-holidays/armenia">Armenia</a></li>
                                                        ...
                                                        <li><a href="<?php echo base_url()?>customized-holidays/bhutan">Bhutan</a></li>
                                                      ...
                                                      <div class="col-md-6 col-sm-12">  
                                                        ...
                                                        <li><a href="<?php echo base_url()?>customized-holidays/kazakhstan">Kazakhstan</a></li>
                                                        <li><a href="<?php echo base_url()?>customized-holidays/kyrgyzstan">Kyrgyzstan</a></li>
                                                        ...
                                                        <li><a href="<?php echo base_url()?>customized-holidays/ukraine">Ukraine</a></li>
                                                        <li><a href="<?php echo base_url()?>customized-holidays/uzbekistan">Uzbekistan</a></li>
                                                      </div>
