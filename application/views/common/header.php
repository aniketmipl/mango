        ...
        <nav class="navbar navbar-default bootsnav" id="navbar-main">
            ...
            <div class="container container-big p-0">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="<?php echo base_url();?>assets/img/Mango-Holidays-logo.png" class="logo" alt=""></a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInUp" data-out="fadeOutDown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url()?>GroupTours/">Rest of Europe</a></li>
                            </ul>
                        </li>    
                        ...
                        <li>
                            <a href="tour-details.html">About Us</a>
                        </li>
                        <!-- <li>
