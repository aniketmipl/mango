...
<footer class="fot-style-2">
   ...
   <div class="container">
      <div class="row sidber">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b> 302, Swojas Capital, 
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b> 5, Adi House, Gokhale Road North, 
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b> 702, 7th Floor, Tulsee Chambers,
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b>    302, 3rd Floor, Pathak House, 
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b>    Shop No.54, First Floor, 
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <address>
                                    <ul class="list-unstyled mar-tp-10">
                                       <li>
                                          <span class="fa fa-map-marker"></span><b>Address :</b>    Office no. 305, 3rd floor, Greens Centre,
                                          <!-- <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
         ...
         <hr style="border-top-color: #5f5c5c;"/>
         <div class="footer-service fo-title">
               <div class="widget">
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/player.min.js"></script>
<!-- Import Filterizr js -->
...
<!-- Import Google api kye -->
<!--  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDCoNSyzalnTvjDpWriq8W2CFXplTHu0qg&amp;callback=initMap" type="text/javascript"></script> -->
<!-- Import mapit js-->
