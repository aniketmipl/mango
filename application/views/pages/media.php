    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 mb-40">
                <div class="hover-box tour-blog-box blog-item-1">
                    <div class="tour-img image">
                        <img src="<?php echo base_url();?>assets/images/blog/kas-jagav-ek-drushtikon-28-october-2018.jpg" alt="">
                        <div class="over-layer">
                            <div class="links">
                                <ul class="list-inline">
                                    <li><a href="<?php echo base_url();?>assets/images/blog/kas-jagav-ek-drushtikon-28-october-2018.pdf" target="_blank"><i class="ion-ios-search-strong"></i></a></li>
                                    <li><a href="<?php echo base_url();?>assets/images/blog/kas-jagav-ek-drushtikon-28-october-2018.pdf" download><i class="fa fa-download"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="tour-item blog-item">
                        <div class="blog-details">
                            ...
                            <h4><a href="#">कसं जगावं ? …….एक दृष्टिकोन</a></h4>
                            <a class="read-btn" href="<?php echo base_url();?>assets/images/blog/kas-jagav-ek-drushtikon-28-october-2018.pdf" target="_blank">Download / View <i class="ion-ios-arrow-thin-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-40">
                <div class="hover-box tour-blog-box blog-item-1">
                    <div class="tour-img image">
                        <img src="<?php echo base_url();?>assets/images/blog/discount-ek-mrugjal-21-10-18.jpg" alt="">
                        <div class="over-layer">
                            <div class="links">
                                <ul class="list-inline">
                                    <li><a href="<?php echo base_url();?>assets/images/blog/discount-ek-mrugjal-21-10-18.pdf" target="_blank"><i class="ion-ios-search-strong"></i></a></li>
                                    <li><a href="<?php echo base_url();?>assets/images/blog/discount-ek-mrugjal-21-10-18.pdf" download><i class="fa fa-download"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="tour-item blog-item">
                        <div class="blog-details">
                            <ul class="list-inline">
                                <li><a href="#"><i class="ion-person"></i> मिलिंद बाबर</a></li>
                                <li><a href="#"><i class="ion-ios-calendar"></i> २१ ऑक्टोबर २०१८ </a></li>
                                <li><a href="#"><i class="ion-chatbubble-working"></i>  मटा</a></li>
                            </ul>
                            <h4><a href="#">डिस्काउंट …..एक मृगजळ</a></h4>
                            <a class="read-btn" href="<?php echo base_url();?>assets/images/blog/discount-ek-mrugjal-21-10-18.pdf" target="_blank">Download / View <i class="ion-ios-arrow-thin-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
