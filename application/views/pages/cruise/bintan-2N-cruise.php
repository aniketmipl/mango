...
<div class="page-title-container">
    <div class="container-tour-heading">
        <div class="page-title pull-left">
          <h1 class="entry-title">Bintan Cruise</h1>
          <?php $cruise_name = 'Bintan Cruise';?>
        </div>
        <ul class="breadcrumbs pull-right">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li><a href="<?php echo base_url()?>cruise">Cruise</a></li>
            <li class="active">Bintan Cruise</li>
        </ul>
    </div>
</div>
...
<section class="blog-single-pages portfolio tour-content cruise-content">
        <div class="page-header-container">
            ...
            <div class="date-mate">
                    ...
                    <h6 class="nights">Nights<span>2</span></h6>
                    <?php $cruise_nights = '2 Nights';?>
            </div>
            </div>
        </div>
                                                                    ...
                                                                    <div class="row">
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <h4><b>Cruise Details</b> </h4>
                                                                                    ...
                                                                                    <p><b>Visa Requirements: Multiple Entry Singapore Visa & Single Entry Indonesia visa</b></p>
                                                                                    <div class="cruise-table">
                                                                                    <table class="table table-bordered">
                                                                                    <tr class="cruise-table-heading">
                                                                                    <th colspan="5">
                                                                                    Bintan / 2 NIGHTS CRUISE (Friday Departure)
                                                                                    </th>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td rowspan="6">-</td>
                                                                                        <td>Jun 5, 12, 19 & 26, 2020</td>
                                                                                    </tr>    
                                                                                    <tr>  
                                                                                        <td>July 3, 10, 17, 24 & 31, 2020</td>
                                                                                    </tr>
                                                                                    <tr>  
                                                                                        <td>Aug 14, 21 & 28, 2020</td>
                                                                                    </tr>
                                                                                    <tr>  
                                                                                        <td>Sep 4, 18 & 25, 2020</td>
                                                                                    </tr>
                                                                                    <tr>  
                                                                                        <td>Oct 2, 9, 16, 23 & 30, 2020</td>
                                                                                    </tr>
                                                                                    <tr>  
                                                                                        <td>Nov 6 & 13, 2020</td>
                                                                                    </tr> 
