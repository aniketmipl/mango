...
<div class="page-title-container">
    <div class="container-tour-heading">
        <div class="page-title pull-left">
          <h1 class="entry-title">Penang - Phuket Cruise</h1>
          <?php $cruise_name = 'Penang - Phuket Cruise';?>
        </div>
        <ul class="breadcrumbs pull-right">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li><a href="<?php echo base_url()?>cruise">Cruise</a></li>
            <li class="active">Penang - Phuket Cruise</li>
        </ul>
    </div>
</div>
                                                                    ...
                                                                    <div class="row">
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <h4><b>Cruise Details</b> </h4>
                                                                                    ...
                                                                                    <p><b>Visa Requirements: Multiple Entry Singapore Visa, Single Entry Malaysia Visa, Single Entry Thailand Visa</b></p>
                                                                                    <div class="cruise-table">
                                                                                    <table class="table table-bordered">
                                                                                    <tr class="cruise-table-heading">
                                                                                    <th colspan="5">
                                                                                    Penang - Phuket / 3 NIGHTS CRUISE (Sunday / Friday Departure)
                                                                                    </th>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>  
                                                                                        ...
                                                                                        <td>1300</td>
                                                                                        <td>2100</td>
                                                                                        <td>Jun 14 & 21, 2020</td>
                                                                                    </tr> 
                                                                                    <tr>  
                                                                                        <td>Tue</td>
                                                                                        <td>Phuket (Deep Sea Port/Marine Custom Pier)</td>
                                                                                        <td>0800(0700)</td>
                                                                                        <td>1600(1500)</td>
                                                                                        <td>July 5 & 12, 2020</td>
                                                                                    </tr> 
                                                                                    <tr>  
                                                                                        <td rowspan="4">Wed</td>
