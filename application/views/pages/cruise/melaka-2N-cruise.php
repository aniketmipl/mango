...
<div class="page-title-container">
    <div class="container-tour-heading">
        <div class="page-title pull-left">
          <h1 class="entry-title">Melaka Cruise</h1>
          <?php $cruise_name = 'Melaka Cruise';?>
        </div>
        <ul class="breadcrumbs pull-right">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li><a href="<?php echo base_url()?>cruise">Cruise</a></li>
            <li class="active">Melaka Cruise</li>
        </ul>
    </div>
</div>
                                                                    ...
                                                                    <div class="row">
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <h4><b>Cruise Details</b> </h4>
                                                                                    ...
                                                                                    <th colspan="5">
                                                                                    Melaka / 2 NIGHTS CRUISE (Wednesday Departure)
                                                                                    </th>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td rowspan="5">-</td>
                                                                                        <td>Jun 3, 17 & 24, 2020</td>
                                                                                    </tr>    
                                                                                    <tr>  
                                                                                        <td>July 8 & 15, 2020</td>
                                                                                    </tr>
                                                                                    <tr>  
                                                                                        <td>Sep 2 & 16, 2020</td>
                                                                                    </tr>
