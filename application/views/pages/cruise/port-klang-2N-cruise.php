...
<div class="page-title-container">
    <div class="container-tour-heading">
        <div class="page-title pull-left">
          <h1 class="entry-title">Port Klang Cruise</h1>
          <?php $cruise_name = 'Port Klang Cruise';?>
        </div>
        <ul class="breadcrumbs pull-right">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li><a href="<?php echo base_url()?>cruise">Cruise</a></li>
            <li class="active">Port Klang Cruise</li>
        </ul>
    </div>
</div>
                                                                    ...
                                                                    <div class="row">
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <h4><b>Cruise Details</b> </h4>
                                                                                    ...
                                                                                    <th colspan="5">
                                                                                    Port Klang / 2 NIGHTS CRUISE (Wednesday Departure)
                                                                                    </th>
                                                                                    </tr>
