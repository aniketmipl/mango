...
<div style="border:1px solid #ccc; border-top:0; border-bottom:0; margin-bottom:0; padding-bottom:10px;">
    ...
    <p style="margin-top:0px; padding-top:0;"><?php echo str_replace('"'," ",$terms_condition);?></p>
    <?php }  ?>

    <p style="margin-top:10px; padding-top:0;" align="center">For detailed terms & conditions, kindly refer to our website www.mangoholidays.in</p>
    ...
    $(".tour_info").click(function(){
      ...
      $.ajax({
          ...
          success:function(res){
                ...
                body_content += '<p>Tour Price Starting From : '+ result.TourPricingHeaders[0].TourPricingDetails[1].CurrencyCode1+' '+ result.TourPricingHeaders[0].TourPricingDetails[0].TotalINRValue.toFixed()+'/- per adult on twin sharing basis!</p>'+
